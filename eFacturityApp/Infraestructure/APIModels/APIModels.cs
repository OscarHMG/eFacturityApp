...
namespace eFacturityApp.Infraestructure.ApiModels
{
    public class APIModels
    {
        ...
        public class NotaCreditoModel
        {
            ...
            {
                Items = new List<ItemDocumentNotaCreditoCabeceraModel>();
                ErroresDocumentos = new List<ErroresDocumentosNotaCredito>();
            }
            public List<ItemDocumentNotaCreditoCabeceraModel> Items { get; set; }
            public List<ErroresDocumentosNotaCredito> ErroresDocumentos { get; set; }
            public long? IdNotaCreditoCabecera { set; get; }

            public long? IdDocumentoCabeceraRelacionado { set; get; }
            public string SecuencialDocumentoCabeceraRelacionado { set; get; }
            ...
            public decimal? ComprobantevSubtotalNoIva { get; set; }
            public decimal? ComprobantevSubSinImpuesto { get; set; }
            public decimal ComprobantevIvatotal { get; set; }
            public string Mensaje { get; set; }
            public bool Exitoso { get; set; }
            public long? DiasCredito { set; get; }
            ...
            public string InformacionAdicionalNotas { set; get; }
            public string RazonModificacion { set; get; }
        }
        public class ErroresDocumentosNotaCredito
        {
            public string Error { get; set; }
            public string TipoError { get; set; }
        }
        public class ItemDocumentNotaCreditoCabeceraModel
        {
            public long? IdNotaCreditoCabecera { set; get; }
            public long? IdNotaCreditodDetalle { set; get; }
            public bool TienePrecioManual { set; get; }
            public decimal Cantidad { get; set; }
            public decimal Subtotal { set; get; }
            public decimal Total { set; get; }
            public decimal Descuento { set; get; }
        ...
        public class ListarDocumentosNotaCreditoGeneradosViewModel
        {
            public ListarDocumentosNotaCreditoGeneradosViewModel()
            {
                Documentos = new List<NotaCreditoModel>();
            }

            public List<NotaCreditoModel> Documentos;
        }
